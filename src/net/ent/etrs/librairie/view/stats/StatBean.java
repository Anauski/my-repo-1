...
public class StatBean implements Serializable {
	...
	private void createPieModel() {
		Map<String, Long> stats = facadeOeuvre.statistiquesOeuvresParAuteur();
		...
		bgColors.add("rgb(89, 105, 255)");
		bgColors.add("rgb(86, 205, 0)");
...
//		Map<String, Long> stats = facadePublication.statistiquesPublicationsPerDate();
...
//    }
	...
	public void init() {
		createPieModel();
//		createBarModel();
		facadePublication.statistiquesPublicationsPerDate();
		facadeOeuvre.statistiquesOeuvresParAuteur();
	}
